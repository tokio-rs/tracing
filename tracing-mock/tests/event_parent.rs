...
fn contextual_parent() {
    let event = expect::event().with_contextual_parent(Some("contextual parent"));
...
#[test]
fn contextual_root() {
    let event = expect::event().with_contextual_parent(None);
...
#[test]
fn explicit_parent() {
    let event = expect::event().with_explicit_parent(Some("explicit parent"));
...
#[test]
fn explicit_root() {
    let event = expect::event().with_explicit_parent(None);
