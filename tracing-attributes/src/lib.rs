...
/// By default, this will be [`INFO`][`Level::INFO`], but if the span level is overridden, the event will be at the same
/// level.
///
...
/// [`Level::INFO`]: https://docs.rs/tracing/latest/tracing/struct.Level.html#associatedconstant.INFO
