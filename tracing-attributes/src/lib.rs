...
use syn::{
    ...
    FieldPat, FnArg, Ident, Item, ItemFn, Pat, PatIdent, PatReference, PatStruct, PatTuple,
    PatTupleStruct, PatType, Path, Signature, Stmt, Token, TypePath, Visibility,
};

mod attr;
use attr::{ErrorMode, Field, Fields, InstrumentArgs};
